            ...
            <div className="title-home text-center bg-color-navbar ">
                ...
                <Card className="filter-home text-start" body>
                    <Row className="px-3">
                        ...
                        <Col xs={1}><Button>ค้นหา</Button></Col>
                    </Row>
                </Card>
            </div>
                                ...
                                <Col xs={3} className="mt-3">
                                    <Card className="card-list-item">
                                        ...
                                        <Card.Body>
                                            ...
                                            <Row>
                                                <Col> <div className="card-subtitle-item mt-2">อายุ 24</div> </Col>
                                                <Col> <div className="card-price-item text-end">฿ 1,200</div></Col>
                                            </Row>
                                        </Card.Body>
                                    </Card>
                                </Col>
